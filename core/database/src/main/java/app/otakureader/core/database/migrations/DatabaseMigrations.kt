 ...
 * seven-day cache — a fetch overwrites the row wholesale, and one happens as soon as it goes stale
 * or the AniList id changes — and a user's manual correction must outlive it.
 */
